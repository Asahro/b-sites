                            ...
                            <div class="panel-group adminpro-custon-design" id="accordion">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading accordion-head judul">
                                        ...
                                        <a data-toggle="collapse" data-parent="#accordion" href="#webmenu">
                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <h2 class="panel-title float-left">Web Menu</h2>
                                                <p class="float-left">Tambah, Hapus, Dan Edit Menu Serta Urutannya</p>
                                            </div>
                                        </a>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading accordion-head judul">
                                        ...
                                        <a data-toggle="collapse" data-parent="#accordion" href="#usermenu">
                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <h2 class="panel-title float-left">User Menu</h2>
                                                <p class="float-left">Tambah, Hapus, Dan Edit Menu Serta Urutannya</p>
                                            </div>
                                        </a>
                                    ...
                                    <div id="usermenu" class="panel-collapse panel-ic collapse <?php echo($this->session->userdata('usermenu'))?> width100">
                                        <div class="panel-body admin-panel-content">
