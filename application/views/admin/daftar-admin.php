                        ...
                        <?php for($i = 0; $i < count($data); $i++){ ?>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 element-item mt30 pb" data-category="admin">
                                <div class="author-widgets-single res-mg-t-30">
                                    <a href="<?php echo base_url()?>admin/daftar-admin/data-lengkap-admin/<?php echo $data[$i]['id'] ?>" class="view">
                                        <i class="fas fa-eye"></i>   
                                    </a>
                                    <a href="<?php echo base_url()?>admin/daftar-admin/edit-admin/<?php echo $data[$i]['id'] ?>" class="edit">
