                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <ul id="myTab4" class="tab-review-design">
                                    <li class="active col-md-4 col-sm-4 col-xs-4 col-lg-6"><a href="#grafikpengurus"><i class="fa fa-user" aria-hidden="true"></i> Grafik Siswa</a></li>
                                    <li class="col-md-4 col-sm-4 col-xs-4 col-lg-6"><a href="#datapengurus"><i class="fa fa-user" aria-hidden="true"></i> Daftar Siswa</a></li>
                                </ul>

                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="grafikpengurus">
                                        <?php $this->load->view('admin/themplate/grafik-siswa'); ?>
                                    </div>
                                    <div class="product-tab-list tab-pane fade" id="datapengurus">
                                        <?php $this->load->view('admin/themplate/data-siswa'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
