            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                        <img src="<?php echo base_url() ?>dassets/img/product/bg-2.jpg" alt="" />
                    </div>
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                        <div class="single-product-details res-pro-tb">
                            ...
                            <div class="single-pro-price">
                                <span class="single-regular">Rp 6.700.000</span>
                            </div>
                            <div class="single-pro-size">
                                <h6>Akses Role</h6>
                                <span style="width: unset;" class="pl-4 pr-4">Membuat Aplikasi</span> 
                                <span style="width: unset;">Mengubah Aplikasi</span> 
                                <span style="width: unset;">Slicing</span> 
                            </div>
                            <div class="single-pro-size">
                                <h6>Sosial Media</h6>
                                <div class="pro-viwer">
