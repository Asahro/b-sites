                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="alert-icon shadow-reset wrap-alert-b">
                            <div class="alert-title col-xs-9 col-sm-9 col-md-9">
                                <h2>Home Page</h2>
                                <p>Sesuaikan Tampilan Home</p>
                            </div>
                            <div class="btn btn-primary col-xs-3 col-sm-3 col-md-3 " onclick="tambahmenuadmin()">Tambah Komponen Web</div>
                            
                            <iframe src="<?php echo base_url() ?>/iframe/themplate-headbar" class="col-12 b-none" style="height: 150px;"></iframe>
                            <iframe src="<?php echo base_url() ?>/iframe/themplate-slider" class="col-12 b-none" style="height: 631px;"></iframe>
