...
jumlah dashboard ada 3 sesuai tpe user
 -->
	<?php $this->load->view('user/themplate/header'); ?>
	
<body>
	<?php $this->load->view('user/themplate/sidebar'); ?>
    <div class="all-content-wrapper">
		<?php $this->load->view('user/themplate/home-headbar'); ?>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                <h4 class="text-left text-uppercase"><b>Totoal Pembelian</b></h4>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-bottom:1px;">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                <h4 class="text-left text-uppercase"><b>Penawaran Terunduh</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    <div class="col-xs-12 cus-gh-hd-pro">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                <h4 class="text-left text-uppercase"><b>Total Pengunjung</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    <div class="col-xs-12 cus-gh-hd-pro">
    ...
    <?php $this->load->view('user/themplate/footer'); ?>