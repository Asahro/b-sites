    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="<?php echo(base_url())?>"><img class="main-logo" src="<?php echo base_url() ?>gambar/themplate/admin-logo.png" alt="" /></a>
            </div>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <?php 
                            ...
                            <li 
                                ...
                                <?php } ?>
                            >
                                <a <?php echo $menu[$i]['arrow'] ?> href="<?= base_url() ?>admin/<?php echo $menu[$i]['link'] ?>">
    							   <i class="fa big-icon <?php echo $menu[$i]['logo'] ?> icon-wrap"></i>
    							   <span class="mini-click-non"><?php echo $menu[$i]['title'] ?></span>
    							</a>
                                
                                <?php 
                                $submenu = $this->modelmenu->ambil_submenu($menu[$i]['id']);
                                if(count($submenu)){ ?>
